                        ...
                        <div class="d-lg-flex">
                            ...
                            <div class="ms-auto my-auto mt-lg-0 mt-4">
                                <div class="ms-auto my-auto">
                                    <a href="{{ route(Request::segment(1) . '.brands.create') }}"
                                        class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Brand</a>
    ...
    <script>
        $(document).ready(function() {
         $('#datatable-basic').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.brands.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        searchable: false
        ...
        function updateStatus(el) {
            ...
            $.post("{{ route(Request::segment(1) . '.brandStatus') }}", {
                    _token: '{{ csrf_token() }}',
                    id: el.value,
                    status: status
                },
